<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="UpdateUser.aspx.cs" Inherits="BestRestaurantNZ.WebForm18" %>
                        ...
                        <tr>
                            <td>
                                <table class="auto-style9">
                                    <tr height="80">
                                        <td colspan="3" class="auto-style14"><strong>Edit User Information</strong></td>
                                    </tr>
                                    <tr height="40">
                                    ...
                                    <tr height="80">
                                        <td class="auto-style7" colspan="3">
                                            <strong>
                                                <asp:Button ID="brnRegister" runat="server" Text="Update User" CssClass="button-big" ValidationGroup="reg" OnClick="Button1_Click" Style="color: #FFFFFF; font-weight: bold; font-size: large; background-color: #FF0000" Width="200px" />&nbsp;&nbsp;&nbsp;&nbsp;
